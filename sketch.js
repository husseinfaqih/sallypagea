...
// function mouseOver1(){
// button.style ('background-color', color(240,0,255));
// }
//
// function mouseOut1(){
//   button.style('font-family', 'Helvetica, sans-serif;')
//   button.style('font-size', '100px')
//   button.style ('color', color(77,238,234));
//   button.style ('background-color', color(77,238,234));
...
//
// function mouseOver2(){
// button1.style ('background-color', color(0,30,255));
// }
//
// function mouseOut2(){
//   button1.style('font-family', 'Helvetica, sans-serif;')
//   button1.style('font-size', '100px')
//   button1.style ('color', color(116,238,21));
//   button1.style ('background-color', color(116,238,21));
//   button1.style ('border-style', 'none');
//   button1.style ('border-radius', '80px');
//   button1.style ('text-align', 'center');
//   // cursor(TEXT);
// }
//
// function mouseOver3(){
// button2.style ('background-color', color(77,238,234));
// }
//
// function mouseOut3(){
//   button2.style('font-family', 'Helvetica, sans-serif;')
//   button2.style('font-size', '100px')
//   button2.style ('color', color(255,231,0));
//   button2.style ('background-color', color(255,231,0));
//   button2.style ('border-style', 'none');
//   button2.style ('border-radius', '80px');
//   button2.style ('text-align', 'center');
//   // cursor(TEXT);
// }
